...
<div id="addContactsModal"
    ...
    <div class="modal-body" style="float: left;">
        <form name="newContactForm" novalidate class="form-horizontal" >
                <div class="form-group lead">
                    <label class="col-sm-2 control-label">* <spring:message code="contacts.name"/>:</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group lead">
                    <label class="col-sm-2 control-label">* <spring:message code="contacts.email"/>:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control"
                               required
               	...
               	<div class="form-group lead">
                    <label class="col-sm-2 control-label">* <spring:message code="contacts.phone"/>:</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control"
                               required
